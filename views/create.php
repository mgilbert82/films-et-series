...
<body>
  ...
  <main class="container-fluid mx-auto w-50">
    <h3 class="text-center mt-5">Publier un nouveau film/série</h3>

    <form method="POST" class="container-fluid w-50 mb-5">
      ...
      <textarea name="synopsis" id="synopsis" cols="30" rows="10" placeholder="Le résumé du film" class="form-control"></textarea>
      ...
      <label for="categoryId" class="form-label">Catégorie de film/série :</label>
